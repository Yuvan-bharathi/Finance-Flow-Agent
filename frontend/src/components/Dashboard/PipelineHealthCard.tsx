...
import type { PipelineHealthItem } from '../../types/reconciliation';
...
const defaultHealth: PipelineHealthItem[] = [
 ...
 */
export const PipelineHealthCard = ({ pipelineHealth = [], onNavigatePipeline }: PipelineHealthCardProps) => {
  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
          <div style={{
            ...
            color: '#ffffff', width: '28px', height: '28px',
            borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center',
            boxShadow: '0 2px 6px rgba(16,185,129,0.25)',
          }}>
            <Activity size={16} />
          </div>
          <h3 style={{ fontSize: '1rem', fontWeight: '800', color: '#0f172a', margin: 0 }}>Pipeline Health</h3>
        </div>
        <span style={{
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '6px', margin: '8px 0' }}>
        {items.map((item, idx) => (
          <div key={idx} style={{
            background: '#fafbfc', border: '1px solid #f1f5f9', borderRadius: '8px',
            padding: '6px 10px', display: 'flex', alignItems: 'center',
            justifyContent: 'space-between', fontSize: '0.75rem',
          }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              <span style={{
      ...
      <button
        ...
        style={{
          ...
          padding: '8px 12px', fontSize: '0.75rem', fontWeight: '700', color: '#059669',
