...
import type { AIPerformanceStats } from '../../types/reconciliation';

interface AIPerformanceCardProps {
  aiPerformance?: Partial<AIPerformanceStats>;
  onNavigateAgentControl?: () => void;
}
 ...
 */
export const AIPerformanceCard = ({ aiPerformance = {}, onNavigateAgentControl }: AIPerformanceCardProps) => {
  const successRate = aiPerformance.success_rate ?? 95.7;
    ...
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
          ...
          <h3 style={{ fontSize: '1rem', fontWeight: '800', color: '#0f172a', margin: 0 }}>AI Agent Performance</h3>
        </div>
        <span style={{
          background: '#dcfce7', color: '#15803d', border: '1px solid #bbf7d0',
          padding: '3px 8px', borderRadius: '6px', fontSize: '0.7rem', fontWeight: '800',
          display: 'inline-flex', alignItems: 'center', gap: '4px',
        }}>7 Active Agents</span>
      </div>
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'right' }}>
          <div style={{ fontSize: '0.7rem', fontWeight: '800', color: '#059669', textTransform: 'uppercase' }}>100% AVAILABLE</div>
          <div style={{ fontSize: '0.72rem', color: '#64748b', marginTop: '2px' }}>Zero SLA Breaches</div>
        </div>
      </div>
      ...
      <button
        ...
        style={{
          ...
          padding: '8px 12px', fontSize: '0.75rem', fontWeight: '700', color: '#4f46e5',
