 ...
 */
export const CollectionReminderModal = ({ company, onClose }: CollectionReminderModalProps) => {
  ...
  useEffect(() => {
    const fetchDraft = async () => {
      try {
        ...
        setDraft(res.data.data as CollectionDraft);
      } catch (err) {
              ...
              <div style={{
                ...
                <div>
                  ...
                  <div style={{ fontSize: '1.1rem', fontWeight: '800', color: '#991b1b', marginTop: '2px' }}>
                    Overdue: ₹{parseFloat(String(draft.overdue_amount || 0)).toLocaleString('en-IN')}
                  </div>
                </div>
