          ...
          <tbody>
            {loading ? (
              ...
              filteredCases.map(item => {
                ...
                const score = rec ? parseFloat(rec.confidence_score) : 0;
