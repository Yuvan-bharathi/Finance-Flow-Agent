...
async function seedComprehensiveData() {
  ...
  try {
    ...
    const schedules = [
      ...
      [51, 16, 2, '2026-08-15', 223000.00, 0.00, 'pending'],
      [52, 17, 2, '2026-08-10', 257833.00, 0.00, 'pending'],
      [53, 18, 2, '2026-08-20', 158200.00, 0.00, 'pending'],
      [54, 19, 2, '2026-08-01', 156750.00, 0.00, 'pending'],
      [55, 20, 2, '2026-08-05', 173090.00, 0.00, 'pending'],
      [56, 21, 2, '2026-08-01', 106406.00, 0.00, 'pending'],
      [57, 22, 2, '2026-08-15', 144300.00, 0.00, 'pending'],
      [58, 23, 2, '2026-08-01', 213750.00, 0.00, 'pending'],
      [59, 24, 2, '2026-08-25', 108138.00, 0.00, 'pending'],
      [60, 25, 2, '2026-08-01', 198222.00, 0.00, 'pending']
    ];
